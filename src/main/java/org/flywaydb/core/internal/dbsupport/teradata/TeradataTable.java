...
public class TeradataTable extends Table {
     ...
     */
    public TeradataTable(JdbcTemplate jdbcTemplate, DbSupport dbSupport, TeradataSchema schema, String name) {
    ...
    protected void doLock() throws SQLException {
        jdbcTemplate.execute("LOCKING TABLE " + dbSupport.quote(schema.getName(), name) + " FOR ACCESS");
    }
}