    ...
    private void createIfNotExists() {
        ...
        while (!table.exists()) {
            ...
            try {
                ...
                InputStream inputStream = new org.springframework.core.io.ClassPathResource("db/migration/init-flyway/createTableHistoryMigration.sql").getInputStream();
                String source = new BufferedReader(new InputStreamReader(inputStream)).lines()
